...
<div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>O.X
.O.
..X
</code></pre></div>
...
<div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>OOO
...
XXX
</code></pre></div>
